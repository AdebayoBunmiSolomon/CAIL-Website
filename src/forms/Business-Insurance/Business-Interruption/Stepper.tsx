...
import { businessInterruptionSteps } from "../../../assets/data/formStepper";
import {
  businessInterruptionFormLookUpTypes1,
  businessInterruptionFormLookUpTypes2,
} from "../../../form-types/lookup";
import {
  businessInterruptionValidationSchema1,
  businessInterruptionValidationSchema2,
} from "../../../form-types/validationSchema";
import { useForm } from "react-hook-form";
import { yupResolver } from "@hookform/resolvers/yup";
import { BusinessInterruptionForm1 } from "./Form1";
import { BusinessInterruptionForm2 } from "./Form2";
import { Stepper } from "react-form-stepper";
import { Button } from "../../../components";
import { GoArrowLeft, GoArrowRight } from "react-icons/go";
import { NavigateFunction, useNavigate } from "react-router-dom";

export const BusinessInterruptionStepper: React.FC<{}> = () => {
  const { activeStep, nextStep, prevStep } = useFormStepper(
    businessInterruptionSteps
  );
  ...
  } = useForm<businessInterruptionFormLookUpTypes1>({
    mode: "onChange",
    resolver: yupResolver(businessInterruptionValidationSchema1),
  });
  ...
  } = useForm<businessInterruptionFormLookUpTypes2>({
    mode: "onChange",
    resolver: yupResolver(businessInterruptionValidationSchema2),
  });
  ...
  return (
    <>
      <div className='pt-[200px] pb-20 px-20'>
        <Stepper steps={businessInterruptionSteps} activeStep={activeStep} />
