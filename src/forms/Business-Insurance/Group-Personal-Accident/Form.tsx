...
import { groupPersonalFormType } from "../../../form-types/Types";
import { groupPersonalValidationSchema } from "../../../form-types/validationSchema";
...
export const GroupPersonalAccidentForm: React.FC<{}> = () => {
  const {
    control,
    handleSubmit,
    formState: { errors },
  } = useForm<groupPersonalFormType>({
    mode: "onChange",
    resolver: yupResolver(groupPersonalValidationSchema),
  });
  const navigate: NavigateFunction = useNavigate();

  const onSubmit = (data: groupPersonalFormType) => {
    console.log("Hello");
    console.log(data);
    navigate("/thank-you");
  };
      ...
      <div className='pt-[200px] pb-20 px-20'>
        <div className='flex flex-col justify-center items-center'>
          <div className='w-[95%] bg-white rounded-md self-center p-6'>
            <FormTitle title='Group Personal Accident' />
