...
import { downloadProps } from "../../types/types";

export const Downloads: React.FunctionComponent<downloadProps> = ({ data }) => {
  const downloadData = data;
  return (
    <>
      <div className='bg-[#FFFFFF] flex justify-center pb-20'>
        <div className='w-[90%]'>
