...
export const MarineClaimRequiredDocumentsDetails: React.FC<useFormProps> = ({
  useFormProps,
}) => {
  ...
  useEffect(() => {
    if (marineClaimFormData.hasThePoliceBeenInformed === "Yes") {
    ...
    <>
      <div className='flex justify-center items-center'>
        <div className='w-[95%] bg-white rounded-md self-center p-6'>
          <FormTitle title='Marine Claim Required Documents' />
          ...
          <div className='flex flex-col md:flex-col lg:flex-row items-center gap-4 mb-3'>
            {marineClaimFormData.doYouHaveAWitness === "Yes" && (
              <Controller
                control={props?.control}
                render={({ field }) => (
                  <FileInput
            ...
            {marineClaimFormData.hasThePoliceBeenInformed === "Yes" && (
              <Controller
                control={props?.control}
                render={({ field }) => (
                  <FileInput
