...
export const enum formRoutes {
  ...
  personal_all_risks = "", //"/products/forms/personal-all-risks"
  ...
  group_life_personal_accident = "/products/forms/group-life-personal-accident",
  ...
  fire_special_perils = "/products/forms/fire-special-perils",
