...
export const resourcesData: resourcesProps[] = [
  {
    ...
    data: [
      ...
      {
        id: 3,
        list: "What is the difference between comprehensive and third party insurance?",
        info: "The difference between comprehensive and third party insurance is that the comprehensive insurance will not only compensate for the death or bodily injury and/or damage you cause to another person’s property but will also compensate you for damage to your vehicle and theft of your vehicle whereas third party only takes care of damage and /or injury you cause to other people i.e. third party (ies)",
      },
      {
        id: 4,
        list: "What are the minimum requirements?",
        info: "The minimum requirement is third party policy",
      },
      {
        id: 6,
      ...
      },
      {
        ...
        info: "Your driving record will affect your insurance in the sense that it will provide a basis for assessing your risk. If your driving record shows adverse features such as conviction for several driving offences, bad claims experience etc, then the insurer will be able to take a decision as to whether to accept or reject your proposal for insurance and if they will accept, it will influence the rate of premium to charge, terms and conditions to impose",
      },
      {
        id: 9,
