...
import { marineHullFormType } from "../../../form-types/Types";
import { marineHullValidationSchema } from "../../../form-types/validationSchema";
...
export const MarineHullForm: React.FC<{}> = () => {
  const {
    control,
    handleSubmit,
    formState: { errors },
  } = useForm<marineHullFormType>({
    mode: "onChange",
    resolver: yupResolver(marineHullValidationSchema),
  });
  const navigate: NavigateFunction = useNavigate();

  const onSubmit = (data: marineHullFormType) => {
    console.log("Hello");
    console.log(data);
    navigate("/thank-you");
  };
