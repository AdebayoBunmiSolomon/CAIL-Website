...
export const AviationClaimRequiredDocumentsDetails: React.FC<useFormProps> = ({
  useFormProps,
}) => {
  ...
  useEffect(() => {
    if (aviationClaimFormData.doYouHaveAWitness === "Yes") {
  ...
  useEffect(() => {
    if (aviationClaimFormData.hasThePoliceBeenInformed === "Yes") {
    ...
    <>
      <div className='flex justify-center items-center'>
        <div className='w-[95%] bg-white rounded-md self-center p-6'>
          <FormTitle title='Aviation Claim Required Documents' />
          ...
          <div className='flex flex-col md:flex-col lg:flex-row items-center gap-4 mb-3'>
            {aviationClaimFormData.doYouHaveAWitness === "Yes" && (
              <Controller
                control={props?.control}
                render={({ field }) => (
                  <FileInput
            ...
            {aviationClaimFormData.hasThePoliceBeenInformed === "Yes" && (
              <Controller
                control={props?.control}
                render={({ field }) => (
                  <FileInput
