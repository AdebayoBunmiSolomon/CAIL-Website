...
import { plantAllRiskFormType } from "../../../form-types/Types";
import { plantAllRiskValidationSchema } from "../../../form-types/validationSchema";
...
export const PlantAllRiskForm: React.FC<{}> = () => {
  const {
    control,
    handleSubmit,
    formState: { errors },
  } = useForm<plantAllRiskFormType>({
    mode: "onChange",
    resolver: yupResolver(plantAllRiskValidationSchema),
  });
  const navigate: NavigateFunction = useNavigate();

  const onSubmit = (data: plantAllRiskFormType) => {
    console.log("Hello");
    console.log(data);
    navigate("/thank-you");
  };
      ...
      <div className='pt-[200px] pb-20 px-20'>
        <div className='flex flex-col justify-center items-center'>
          <div className='w-[95%] bg-white rounded-md self-center p-6'>
            <FormTitle title='Plant All Risk' />
