...
import { businessOwnersValidationSchema } from "../../../form-types/validationSchema";
import { yupResolver } from "@hookform/resolvers/yup";
import { businessOwnersFormTypes } from "../../../form-types/Types";
import {
  Button,
  FormTitle,
  SelectOptions,
...
export const BusinessOwnersForm: React.FC<{}> = () => {
  const {
    control,
    handleSubmit,
    formState: { errors },
  } = useForm<businessOwnersFormTypes>({
    mode: "onChange",
    resolver: yupResolver(businessOwnersValidationSchema),
  });
  const navigate: NavigateFunction = useNavigate();

  const onSubmit = (data: businessOwnersFormTypes) => {
    console.log("Hello");
    console.log(data);
    navigate("/thank-you");
  };
      ...
      <div className='pt-[200px] pb-20 px-20'>
        <div className='flex flex-col justify-center items-center'>
          <div className='w-[95%] bg-white rounded-md self-center p-6'>
            <FormTitle title='Business Owners' />
