...
export const PackagedPolicyClaimRequiredDocumentsDetails: React.FC<
  useFormProps
> = ({ useFormProps }) => {
  ...
  useEffect(() => {
    if (packagedPolicyClaimFormData.doYouHaveAWitness === "Yes") {
  ...
  useEffect(() => {
    if (packagedPolicyClaimFormData.hasThePoliceBeenInformed === "Yes") {
    ...
    <>
      <div className='flex justify-center items-center'>
        <div className='w-[95%] bg-white rounded-md self-center p-6'>
          <FormTitle title='Packaged Policy Claim Required Documents' />
          ...
          <div className='flex flex-col md:flex-col lg:flex-row items-center gap-4 mb-3'>
            {packagedPolicyClaimFormData.doYouHaveAWitness === "Yes" && (
              <Controller
                control={props?.control}
                render={({ field }) => (
                  <FileInput
            ...
            {packagedPolicyClaimFormData.hasThePoliceBeenInformed === "Yes" && (
              <Controller
                control={props?.control}
                render={({ field }) => (
                  <FileInput
