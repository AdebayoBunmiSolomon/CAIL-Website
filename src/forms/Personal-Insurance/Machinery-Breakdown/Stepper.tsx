...
import { PersonalInsuranceMachineryBreakdownForm2 } from "./Form2";
import { PersonalInsuranceMachineryBreakdownForm1 } from "./Form1";
import { Stepper } from "react-form-stepper";
import { Button } from "../../../components";
import { GoArrowLeft, GoArrowRight } from "react-icons/go";
import { NavigateFunction, useNavigate } from "react-router-dom";

export const PersonalInsuranceMachineryStepper: React.FC<{}> = () => {
  ...
  const getActiveStepComponent = () => {
    switch (activeStep) {
      case 0:
        return (
          <PersonalInsuranceMachineryBreakdownForm1
            useFormProps={{
              control: stepOneControl,
      ...
      case 1:
        return (
          <PersonalInsuranceMachineryBreakdownForm2
            useFormProps={{
              control: stepTwoControl,
