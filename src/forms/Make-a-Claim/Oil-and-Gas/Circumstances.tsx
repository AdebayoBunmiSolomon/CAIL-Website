...
export const OilAndGasClaimCircumstances: React.FC<useFormProps> = ({
  useFormProps,
}) => {
  const { oilAndGasClaimFormData, setOilAndGasClaimFormData } =
    useOilAndGasClaimForm();
  ...
  useEffect(() => {
    if (globalData.doYouHaveAWitness === true) {
      props?.setValues("nameOfWitness", oilAndGasClaimFormData.nameOfWitness);
      props?.setValues(
        "witnessContactInfo",
        oilAndGasClaimFormData.witnessContactInfo
      );
      return;
    } else {
  ...
  useEffect(() => {
    if (globalData.hasThePoliceBeenInformed === true) {
      props?.setValues(
        ...
        oilAndGasClaimFormData.policeStationAddress
      );
    ...
    <>
      <div className='flex justify-center items-center'>
        <div className='w-[95%] bg-white rounded-md self-center p-6'>
          <FormTitle title='Oil and Gas Claim Circumstances' />
