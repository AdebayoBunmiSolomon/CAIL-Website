...
export const OilAndGasClaimSummary: React.FC<{}> = () => {
                ...
                <td className='px-6 py-4 whitespace-nowrap'>
                  <div className='flex items-center'>
                    <div className='ml-4'>
                      ...
                      <div className='text-sm text-gray-500'>
                        {oilAndGasClaimFormData.claimType}
                      </div>
                    </div>
                  </div>
                </td>
                ...
                <td className='px-6 py-4 whitespace-nowrap'>
                  <div className='flex items-center'>
                    <div className='ml-4'>
                      ...
                      <div className='text-sm text-gray-500'>
                        {oilAndGasClaimFormData.dateTimeOfIncident}
                      </div>
                    </div>
                  </div>
                </td>
                ...
                <td className='px-6 py-4 whitespace-nowrap'>
                  <div className='flex items-center'>
                    <div className='ml-4'>
                      ...
                      <div className='text-sm text-gray-500'>
                        {formatAmount(
                          Number(oilAndGasClaimFormData.claimsAmount)
                        )}
                      </div>
                    </div>
                  </div>
