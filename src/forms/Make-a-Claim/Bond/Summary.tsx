...
export const BondClaimSummary: React.FC<{}> = () => {
    ...
    <div>
      ...
      <div className='flex justify-center items-center'>
        <div className='w-[95%] bg-white rounded-md self-center p-6'>
          <FormTitle title='Bond Claims Summary' />
                ...
                <td className='px-6 py-4 whitespace-nowrap'>
                  <div className='flex items-center'>
                    <div className='ml-4'>
                      ...
                      <div className='text-sm text-gray-500'>
                        {bondClaimFormData.dateTimeOfIncident}
                      </div>
                    </div>
                  </div>
                </td>
                ...
                <td className='px-6 py-4 whitespace-nowrap'>
                  <div className='flex items-center'>
                    <div className='ml-4'>
                      ...
                      <div className='text-sm text-gray-500'>
                        {formatAmount(Number(bondClaimFormData.claimsAmount))}
                      </div>
                    </div>
                  </div>
                </td>
