...
export const OilAndGasClaimRequiredDocumentsDetails: React.FC<useFormProps> = ({
  ...
  useEffect(() => {
    if (oilAndGasClaimFormData.doYouHaveAWitness === "Yes") {
  ...
  useEffect(() => {
    if (oilAndGasClaimFormData.hasThePoliceBeenInformed === "Yes") {
    ...
    <>
      <div className='flex justify-center items-center'>
        <div className='w-[95%] bg-white rounded-md self-center p-6'>
          <FormTitle title='Oil & Gas Claim Required Documents' />
          ...
          <div className='flex flex-col md:flex-col lg:flex-row items-center gap-4 mb-3'>
            {oilAndGasClaimFormData.doYouHaveAWitness === "Yes" && (
              <Controller
                control={props?.control}
                render={({ field }) => (
                  <FileInput
            ...
            {oilAndGasClaimFormData.hasThePoliceBeenInformed === "Yes" && (
              <Controller
                control={props?.control}
                render={({ field }) => (
                  <FileInput
