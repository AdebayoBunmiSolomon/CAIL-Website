...
export const executives: tabContentsType[] = [
  {
    id: 1,
    ...
    tabData: [
      {
        id: 1,
        title: "Mr. Ibrahim Dikko",
        description:
          "Mr. Ibrahim Dikko graduated with an LL.M [Corporate & Commercial Law] degree from Queen Mary & Westfield College, University of London, England after obtaining his LL. B from the University of Buckingham, England. He was called to the Nigeria Bar in 1990. He has worked in several capacities and industries that span across banking, information technology and telecommunications.He worked in Kenneth Michael & Co between 1991 and 1992 and was on the team responsible for setting up the first discount house in Nigeria. He served as the Chairman of First Securities Discount House Limited from 2002 – 2012 and worked as an Executive Director in Resourcery Plc from 2000 to 2007. He was also Vice President [Regulatory and Corporate Affairs] at Etisalat Nigeria from 2007 to 2017. Mr. Dikko sits on the Board of the Society for Corporate Governance Nigeria and Baker Hughes Company Limited. He sits on several Boards of both quoted and private companies including Custodian and Allied Insurance Limited..",
        position: "Chairman",
        getQuote: "",
        keyFeatures: [],
        benefits: [],
      },
      {
        ...
        description:
          "Mr. Isujeh has over thirty years’ experience in the Insurance Industry, having worked in different insurance companies in Insurance Operations, Sales/Business Development and General Management. At Custodian, he has at various times coordinated the Marketing and Technical Operations of the company. As a result of his commitment and hard work, he was appointed Executive Director of the company in 2016. He holds a Bachelor of Science degree in Insurance from the University of Lagos and is a member of the Chartered Insurance Institute, London. Aside from various Technical courses attended in and outside Nigeria, he has over the years attended management courses preparing him for leadership role. He is an Alumnus of the Lagos Business School as well as the prestigious Wharton Business School, USA where he attended Executive programmes..",
        title: "Edeki Isujeh",
        getQuote: "",
        keyFeatures: [],
        benefits: [],
      ...
      },
      {
        ...
        position: "Non-Executive Director",
        description:
          "Mr. Adeniyi Falade is a Chartered Accountant, Chartered Stockbroker and an Investment Banker. He had his professional accountancy training at PricewaterhouseCoopers, and Coopers & Lybrand Limited, Lagos. He holds a Master of Business Administration (MBA) from the University of Warwick, United Kingdom and a Bachelor of Science degree (BSc), from the University of Ibadan. Before his appointment as Executive Director of Custodian Investment PLC, he had served as Managing Director of Crusader Sterling Pensions Limited, Managing Director of Lead Capital and Head of Investment Banking Group of Ecobank Nigeria Plc and Lead Bank Plc. He had also at various times served as Head of Internal Control/ Chief Inspector and Head of Risk Management Department of Lead Bank Plc. He is also a member of the Board of Directors of Custodian Life Assurance Limited, Custodian Trustees Limited, UPDC PLC and Interstate Securities Limited...",
        title: "Adeniyi Falade",
        getQuote: "",
        keyFeatures: [],
        benefits: [],
      },
  ...
  },
  {
    ...
    tabData: [
      ...
      {
        id: 5,
        position: "Head, Nothern Region",
        description:
          "Kate has over twenty - three years' experience in the insurance industry, which cuts across Marketing and Branch Operations. She started her career with Custodian and Allied Insurance Limited in Lagos in the Marketing department and her stellar performance led to her being seconded to start the Abuja branch of the organization. As a result of her continued commitment and hard work, she was appointed as the Head, Northern Operations, to oversee Abuja and all the branches in the North in 2016. She holds a bachelor's degree in History from the University of Uyo, Nigeria. She is an alumnus of Lagos Business School (SMP65) and has attended many Insurance, Marketing & Management courses and seminars both locally and abroad.",
        title: "Kate Ojih",
        getQuote: "",
        keyFeatures: [],
        benefits: [],
